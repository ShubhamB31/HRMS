      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
              <a class="nav-link js-scroll-trigger" href="../attendance_display/report.php">Report</a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
              <a class="nav-link js-scroll-trigger" href="/hrms/index.php">Logout</a>
	          </li>
          </ul>
...
<br><br><br><br><br>	
<h2><strong>Today's Report</strong></h2><br>
<h4><p><span id="datetime"></span></p></h4>
...
document.getElementById("datetime").innerHTML = dt.toLocaleDateString();
          ...
          <tbody> 
                <div class="table100-body js-pscroll">
								<?php
									$no 	= 1;
									while ($row = mysqli_fetch_array($queryRpert))
									{

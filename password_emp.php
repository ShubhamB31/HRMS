...
<br>
<br>
 <form class="form-horizontal" role="form" method="post"  action = "password_emp.php" >
          <div class="form-group">
            <label class="col-lg-3 control-label"><h2>Change Password</h2></label>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <div class="col-md-7">
              <button type="submit" class="btn btn-primary" name="changePassword">Save Changes</button></div>
              <span></span>
            </div>
          </div>

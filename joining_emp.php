...
<br>
<br>
<?php $row = mysqli_fetch_array($queryjoin);  ?>
 <form class="form-horizontal" role="form" method="post"  action = "joining_emp.php">
          <div class="form-group">
            <label class="col-lg-3 control-label"><h2>Joining Details</h2> 
          </div>
          <div class="form-group">
            <label class="col-lg-3 control-label">Date of Joining:</label>
            <div class="col-md-7">
              <input class="form-control" type="date" name = "doj" value="<?php echo $row['doj'] ?>">
            </div>
          </div>
          <br>
          <div class="form-group">
            <label class="col-lg-3 control-label">Date of Confirmation:</label>
            <div class="col-md-7">
              <input class="form-control" type="date" name = "doc" value="<?php echo $row['doc'] ?>">
            </div>
          </div>
          <br>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <div class="col-md-7">
              <input class="form-control" type="text" name = "previousCompany" value="<?php echo $row['previousCompany'] ?>">
            </div>
          </div>
          <br>
          <div class="form-group">
...
<br>
    ...
    <br></br>
          <div class="form-group">
            ...
            <div class="col-md-7">
             <button type="submit" class="btn btn-primary" name="joining">Save Changes</button></div>
              <span></span>
            </div>
          </div>

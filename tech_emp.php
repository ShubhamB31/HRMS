...
<br>
<br>
<?php $row = mysqli_fetch_array($query5);  ?>
 <form class="form-horizontal" role="form" method="post"  action = "tech_emp.php">
          <div class="form-group">
            <label class="col-lg-3 control-label"><h2>Technical Details</h2></label>
          </div>
          <br>
          <div class="form-group">
...
<br></br>
          <div class="form-group">
            ...
            <div class="col-md-7">
              <button type="submit" class="btn btn-primary" name="technical">Save Changes</button></div>
              <span></span>
            </div>
          </div>

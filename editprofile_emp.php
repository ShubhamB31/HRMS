...
<br>
                ...
                <?php $row = mysqli_fetch_array($query1);  ?>
 <form class="form-horizontal" role="form" method="post"  action = "editprofile_emp.php">
          <div class="form-group">
            <label class="col-lg-3 control-label"><h2>Edit Profile</h2></label>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <div class="col-md-7">
              <input class="form-control" type="text" name= "username" value="<?php echo $row['user_name'] ?>">
            </div>
          </div>
          <br>
          <div class="form-group">
...
<br>
    ...
    <div class="form-group">
        ...
        <div class="form-group">
            ...
            <div class="col-md-7">
          <!-- <input type="button" class="btn btn-primary" name = "edit_profile" value="Save Changes">  -->
               <button type="submit" class="btn btn-primary" name="edit_profile">Save Changes</button></div>
              <span></span>
            </div>
          </div>
